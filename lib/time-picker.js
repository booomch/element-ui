            ...
            directives: [
              {
                name: "mask",
                rawName: "v-mask",
                value: _vm.maskByFormat,
                expression: "maskByFormat"
              },
              {
                name: "clickoutside",
...
var external_vue_the_mask_ = __webpack_require__(22);
...
/* harmony default export */ var pickervue_type_script_lang_js_ = ({
  ...
  computed: {
    maskByFormat: function maskByFormat() {
    ...
    mountPicker: function mountPicker() {
      ...
      var updateOptions = function updateOptions() {
        ...
        if (options && options.selectableRange) {
          ...
          var _format = DEFAULT_FORMATS.timerange;

          ranges = Array.isArray(ranges) ? ranges : [ranges];
          _this3.picker.selectableRange = ranges.map(function (range) {
            return parser(range, _format, _this3.rangeSeparator);
          });
        }
